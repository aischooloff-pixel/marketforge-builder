        ...
        <div className="flex items-start gap-2">
          ...
          <div className="text-[11px] sm:text-xs text-muted-foreground leading-relaxed space-y-1.5">
            <p>
              ...
              Администрация TEMKA.STORE не несёт ответственности за действия покупателей после приобретения товара.
            </p>
            <p>
            ...
            <p>
              Платформа является техническим посредником (ст. 1253.1 ГК РФ). Оформляя заказ, вы принимаете полную ответственность за использование товаров.{' '}
