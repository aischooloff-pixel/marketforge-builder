...
export const TIGER_COUNTRIES: TigerCountry[] = [
  ...
  { code: '173', name: 'Бермуды', flag: 'bm' },
  { code: '174', name: 'Гренада', flag: 'gd' },
  { code: '175', name: 'Антигуа и Барбуда', flag: 'ag' },
  { code: '176', name: 'Барбадос', flag: 'bb' },
  { code: '177', name: 'Сент-Люсия', flag: 'lc' },
  { code: '178', name: 'Доминика', flag: 'dm' },
  { code: '179', name: 'Сент-Винсент', flag: 'vc' },
  { code: '180', name: 'Белиз', flag: 'bz' },
  { code: '181', name: 'Кабо-Верде', flag: 'cv' },
  { code: '182', name: 'Восточный Тимор', flag: 'tl' },
  { code: '183', name: 'Бутан', flag: 'bt' },
  { code: '184', name: 'Бруней', flag: 'bn' },
  { code: '185', name: 'Лихтенштейн', flag: 'li' },
  { code: '186', name: 'Сан-Марино', flag: 'sm' },
  { code: '187', name: 'Андорра', flag: 'ad' },
  { code: '188', name: 'Маршалловы Острова', flag: 'mh' },
  { code: '189', name: 'Тонга', flag: 'to' },
  { code: '190', name: 'Самоа', flag: 'ws' },
  { code: '191', name: 'Вануату', flag: 'vu' },
  { code: '192', name: 'Соломоновы Острова', flag: 'sb' },
  { code: '193', name: 'Микронезия', flag: 'fm' },
  { code: '194', name: 'Палау', flag: 'pw' },
  { code: '195', name: 'Тувалу', flag: 'tv' },
  { code: '196', name: 'Науру', flag: 'nr' },
  { code: '197', name: 'Кирибати', flag: 'ki' },
  { code: '198', name: 'Эритрея', flag: 'er' },
  { code: '199', name: 'Центральноафр. Респ.', flag: 'cf' },
  { code: '200', name: 'Гвинея-Бисау', flag: 'gw' },
