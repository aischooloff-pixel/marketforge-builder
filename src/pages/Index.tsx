          ...
          <div className="container mx-auto px-4">
            ...
            >
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bevel-raised bg-card text-foreground text-xs md:text-sm font-medium mb-4 md:mb-8"
              >
                <PxShield size={16} />
                ​Проверенный шоп · Множество сделок
              </motion.div>
          ...
          <div className="container mx-auto px-4">
            ...
            {productsLoading ? (
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className="win95-window p-2">
              ...
              <div className="text-center py-12 text-muted-foreground font-mono">
                <p>&gt; Завоз скоро. Следи за каналом</p>
              </div>
            )}
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            {categoriesLoading ? (
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4">
                {[...Array(8)].map((_, i) => (
                  <div key={i} className="p-4 md:p-6 border bg-card">
          ...
          <div className="container mx-auto px-4">
            ...
            {reviewsLoading ? (
              ...
              <div className="text-center py-8 text-muted-foreground font-mono">
                <p>&gt; Отзывов пока нет. Будь первым, кто отпишется</p>
              </div>
            )}
            {reviews.length > 0 && (
              <p className="text-center text-xs text-muted-foreground mt-2 font-mono">◄ Листайте ►</p>
            )}
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Администрация не несёт ответственности за действия покупателей. Все товары предоставляются «как есть».
                  Претензии через диспут.
                </p>
              </div>
              <Link to="/disclaimer">
